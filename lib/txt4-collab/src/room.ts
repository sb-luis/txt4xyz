...
// gc:false would grow sync payloads by ~75x on delete-heavy sessions without failing anything.
...
// replaceState, not pushState: pushState would trap the back button in a mint-then-redirect loop on every bare /edit visit.
