...
describe("formatPython", () => {
  ...
  it("wraps a thrown formatting error as FormatError", async () => {
    ...
    await expect(formatPython("def f(:")).rejects.toBeInstanceOf(FormatError);
  });
});
